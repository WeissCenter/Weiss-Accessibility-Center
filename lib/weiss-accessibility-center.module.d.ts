...
import * as i1 from "./weiss-accessibility-center.component";
import * as i2 from "./weiss-accessibility-center.directive";
import * as i3 from "./templates/strip/strip.component";
import * as i4 from "./templates/panel/panel.component";
import * as i5 from "@angular/common";
import * as i6 from "@angular/forms";
export declare class WeissAccessibilityCenterModule {
