...
class StripComponent {
    ...
    constructor(weissAccessibilityCenterService) {
        ...
        this.statusMessageChange = new EventEmitter();
        this.moduleKeys = [];
        this.selectedModule = undefined;
        this.dynamicTabIndex = 3;
        this.closeSelectionPanel = false;
        this.showSelectionPanel = false;
    }
    close() {
...
class WeissAccessibilityCenterComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.7", ngImport: i0, type: WeissAccessibilityCenterComponent, deps: [{ token: WeissAccessibilityCenterService }], target: i0.ɵɵFactoryTarget.Component }); }
...
class WeissAccessibilityToggleDirective {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.2.7", ngImport: i0, type: WeissAccessibilityToggleDirective, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: WeissAccessibilityCenterService }], target: i0.ɵɵFactoryTarget.Directive }); }
