...
import { PLATFORM_ID, Inject, Injectable, EventEmitter, ViewChildren, ViewChild, Output, Input, ViewEncapsulation, Component, ElementRef, HostListener, Directive, NgModule } from '@angular/core';
...
class WeissAccessibilityCenterService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterService, deps: [{ token: DOCUMENT }, { token: PLATFORM_ID }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterService, providedIn: "root" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: "root",
                }]
...
class StripComponent {
    ...
    dynamicTabIndex = 3;
    moduleOrder = ['fontSize', 'spacing', 'theme', 'layout', 'language'];
 ...
 */
function createAccessibilityOptions(service, t) {
...
class WeissAccessibilityCenterComponent {
    ...
    getInitialFocusElement() {
        return this.centerEl?.nativeElement.querySelector('[data-weiss-initial-focus="true"]') ?? null;
    }
    ngOnChanges(changes) {
        if (changes["options"] &&
  ...
  `, isInline: true, dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i2.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }, { kind: "component", type: PanelComponent, selector: "weiss-accessibility-panel", inputs: ["data", "closeLabel", "resetAllLabel", "resetStatusMessage"], outputs: ["statusMessageChange"] }, { kind: "component", type: StripComponent, selector: "weiss-accessibility-strip", inputs: ["data", "closeLabel", "resetLabel", "resetStatusMessage", "closeSelectionPanel"], outputs: ["statusMessageChange"] }], encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterComponent, decorators: [{
            type: Component,
            args: [{
...
class WeissAccessibilityToggleDirective {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityToggleDirective, deps: [{ token: i0.ElementRef }, { token: i0.Renderer2 }, { token: WeissAccessibilityCenterService }], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "20.3.16", type: WeissAccessibilityToggleDirective, isStandalone: true, selector: "[weissA11yToggle]", inputs: { targetId: ["weissA11yToggle", "targetId"] }, host: { listeners: { "click": "onClick($event.target)", "keydown": "onKeyDown($event)" } }, usesOnChanges: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityToggleDirective, decorators: [{
            type: Directive,
            args: [{
...
class WeissAccessibilityCenterModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterModule, imports: [CommonModule,
            FormsModule,
            AsyncPipe,
            WeissAccessibilityCenterComponent,
            WeissAccessibilityToggleDirective,
            StripComponent,
            PanelComponent], exports: [WeissAccessibilityCenterComponent,
            WeissAccessibilityToggleDirective] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterModule, providers: [WeissAccessibilityCenterService], imports: [CommonModule,
            FormsModule,
            WeissAccessibilityCenterComponent,
            StripComponent,
            PanelComponent] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.16", ngImport: i0, type: WeissAccessibilityCenterModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [],
                    imports: [
