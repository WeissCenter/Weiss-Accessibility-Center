...
import { Injectable, Inject, EventEmitter, Component, ViewEncapsulation, Input, Output, ViewChildren, ViewChild, HostListener, Directive, NgModule } from '@angular/core';
