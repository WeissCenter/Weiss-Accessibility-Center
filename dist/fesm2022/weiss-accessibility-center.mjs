...
import { Injectable, Inject, EventEmitter, Component, ViewEncapsulation, Input, Output, ViewChild, ViewChildren, HostListener, Directive, NgModule } from '@angular/core';
